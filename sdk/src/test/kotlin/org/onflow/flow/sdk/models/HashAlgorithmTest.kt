...
class HashAlgorithmTest {
    ...
    fun `Test fromCadenceIndex`() {
        ...
        assertEquals(HashAlgorithm.SHA3_256, HashAlgorithm.fromCadenceIndex(2))
        assertEquals(HashAlgorithm.KMAC128, HashAlgorithm.fromCadenceIndex(3))
        assertEquals(HashAlgorithm.KECCAK256, HashAlgorithm.fromCadenceIndex(4))
    }
}
